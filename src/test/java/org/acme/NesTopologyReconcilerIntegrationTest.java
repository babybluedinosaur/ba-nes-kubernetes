...
class NesTopologyReconcilerIntegrationTest {
    ...
    LocallyRunOperatorExtension extension =
            LocallyRunOperatorExtension.builder()
                    .withReconciler(NesTopologyReconciler.class)
                    .build();
    ...
    NesTopology testResource() {
        var resource = new NesTopology();
        resource.setMetadata(new ObjectMetaBuilder()
                .withName(RESOURCE_NAME)
                .build());
        resource.setSpec(new NesTopologySpec());
